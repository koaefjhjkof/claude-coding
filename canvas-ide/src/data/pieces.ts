...
export const PIECES: PieceDef[] = [
  ...
  // ── Media ──────────────────────────────────────────────────────────────────
  {
    ...
    defaultWidth: 240,
    defaultHeight: 180,
    defaultProps: { src: 'https://picsum.photos/seed/canvas/400/300', borderRadius: 12 },
  },
  {
    type: 'avatar',
    label: 'Avatar',
  ...
  // ── Data & Media ──────────────────────────────────────────────────────────
  {
    ...
    defaultWidth: 280,
    defaultHeight: 160,
    defaultProps: { src: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4', borderRadius: 12 },
  },
  {
    type: 'map',
    label: 'Map',
    ...
    defaultWidth: 280,
    defaultHeight: 180,
    defaultProps: { text: 'New York, USA', borderRadius: 12 },
  },
  {
    type: 'chart',
    label: 'Bar Chart',
